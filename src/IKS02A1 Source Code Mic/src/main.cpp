/* This example was developed for Nucleo F411RE or L476RG only. If you want to use other Nucleo or Architecture 
 * you have to implement the dedicated file to manage the low level PDM part
 */
#if !defined(ARDUINO_NUCLEO_L476RG) && !defined(ARDUINO_NUCLEO_F411RE)
#error "This example is only for STM32 Nucleo-F411RE!"
#endif
