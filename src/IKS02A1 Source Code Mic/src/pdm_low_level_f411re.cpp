...
void SystemClock_Config(void)
{
  ...
  */
  ...
  RCC_OscInitStruct.PLL.PLLN = 336;  // Same PLL multiplier for 84 MHz
  RCC_OscInitStruct.PLL.PLLP = RCC_PLLP_DIV4;  // PLLP = 4 for 84 MHz SYSCLK
  RCC_OscInitStruct.PLL.PLLQ = 7;  // For USB and other peripherals
